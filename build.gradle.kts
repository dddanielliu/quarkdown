...
// - `jdk.zipfs`: reading zip/JAR files via java.nio.file.FileSystems (used by Playwright Java driver).
val jlinkSpiModules = listOf("jdk.crypto.ec", "jdk.localedata", "jdk.zipfs")
